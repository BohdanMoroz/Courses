...
//    String REGEX_NAME_UA = "[\u0410-\u0429\u0404\u0406\u0407]+-?[А-ЩЬЮЯЄІЇа-щьюяєії]+";
    ...
    String REGEX_COMMENT = "[A-Za-z0-9]+";
    ...
    public void execute(){
        ...
        tempNote.setSurname(inputValidValue(scanner, REGEX_NAME));
        ...
        tempNote.setNickname(inputValidValue(scanner, REGEX_NAME));
        tempNote.setComment(inputValidValue(scanner, REGEX_NAME));
//        tempNote.setGroup();
